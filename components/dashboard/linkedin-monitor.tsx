...
export function LinkedInMonitor({ recentComments }: LinkedInMonitorProps) {
    ...
    <div className="card p-5 w-full">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-medium">LinkedIn Comments</h3>
        </div>
        <a
          ...
          >
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                {comment.authorTitle && (
                  <p className="text-xs opacity-70 mt-0.5">{comment.authorTitle}</p>
                )}
